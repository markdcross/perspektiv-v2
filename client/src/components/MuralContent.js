...
import VisitedTotal from "./VisitedTotal";
import VisitState from "../context/VisitState";
		...
		<VisitState>
			...
			<Row className='pt-2 bigScroll'>
                ...
                <Col xs={5} className="text-right"> */}
									...
									<VisitedTotal
										muralTotal={singleMuralState.data.data.visits.length}
										muralID={singleMuralState.data.data.id}
									/>
